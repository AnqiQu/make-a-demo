...
- **Browser Action**: One typed, declarative browser interaction or assertion in a Browser Scene, such as navigation, clicking, filling, selecting, pressing a key, or asserting visible state. On-camera Browser Actions are grounded in Action Catalog and Flow Spec evidence and are compiled by the backend; they are not raw Playwright statements.

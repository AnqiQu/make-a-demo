...
- **External Resource Cache**: A backend-owned, content-addressed Pipeline Job artifact containing credential-free public browser resources discovered during App Exploration or Capture Path Validation. Cached responses are replayed locally during exploration, validation, and capture without opening the Sandbox network boundary.

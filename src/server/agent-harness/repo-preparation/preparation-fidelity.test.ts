...
describe("validatePreparationFidelity", () => {
  ...
  it("accepts lockfile changes in a dependency repair delta as backend-owned", () => {
    // Lockfiles are owned by the backend package manager: install-window
    // reconciliation rewrites them between diff captures, so repair-delta
    // attribution is unreliable, and frozen installation re-derives their
    // content from package.json regardless of what a repair wrote.
  ...
  it("accepts lockfile changes in any repair delta as backend-owned", () => {

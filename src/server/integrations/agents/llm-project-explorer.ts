import type { ProjectExplorationResult } from "../../script-generation/project-exploration/project-exploration-result";
import type {
  ProjectExplorationInput,
  ProjectExplorer,
} from "../../script-generation/project-exploration/project-explorer.interface";
